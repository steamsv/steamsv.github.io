...
解锁服务 可以帮助你的设备获得流媒体接入权限。不同于 v2ray、ss、xray等 的地方是它不需要任何代理程序，只需要把DNS请求转发至我们提供的DNS或自行组建的DNS服务并设置重定向规则，或把流媒体流量路由至我们提供的stream IP。如果你想要熟练的运用它，只需要理解它的原理[原理介绍](principle.md)。
...
- 本站只提供dns及sniproxy/stream ip接入服务，文档只提供部分示例，其它不在范围内
